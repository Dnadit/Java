...
class Bag<T extends Solid> {
  ...
  boolean isSameOwner(Bag<?> obj) {            // ? << 와일드카드(아무거나 가짐) boolean isSameOwner(Bag<Book> obj)
...
public class BagTest {
  ...
  public static void main(String[] args) {
    ...
    boolean result = bag.isSameOwner(bag2); // isSameOwner메서드에서 this는 Book, obj은 PencilCase이기 때문에 error.
